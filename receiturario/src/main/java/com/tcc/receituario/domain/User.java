package com.tcc.receituario.domain;
...
public class User implements Serializable {
	...
	public User(Integer id, String nome, String email, String cpfOuCnpj, TipoPerfil tipo, String senha) {
		super();
		this.id = id;
		this.nome = nome;
		this.email = email;
